...
- AI agent sessions (LLM agent traces — NOT browser replays): get_agent_sessions_overview -> list_agent_sessions -> get_agent_session -> get_agent_session_transcript -> inspect_agent_session_span
- Agent tool health: get_agent_tools_overview -> list_agent_tool_errors -> get_agent_tool_error
