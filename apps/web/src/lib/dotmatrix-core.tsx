...
export function diagonalWave3BandIndex(row: number, col: number, direction: DiagonalWave3Direction): number {
...
export function createDiagonalWave3Component(displayName: string, direction: DiagonalWave3Direction) {
...
export function createGlyphSpin3Component(displayName: string, glyph: readonly number[], defaultSpeed = 1) {
