import { githubInstallations } from "@maple/db"
...
export const runGithubScheduledReconcile = Effect.fn("runGithubScheduledReconcile")(function* () {
	const database = yield* Database
	const queue = yield* GithubSyncQueue
	const installations = yield* database.execute((db) =>
