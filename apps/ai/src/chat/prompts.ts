...
- unit: one of number, percent (a fraction, so 0.045 is 4.5% — a tool table that prints 92.86% charts as 0.9286), duration_ms, duration_s, duration_us, duration_ns, bytes, requests_per_sec
