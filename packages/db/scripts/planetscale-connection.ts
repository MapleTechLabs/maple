#!/usr/bin/env bun
/**
 * Shared PlanetScale-CLI credential broker for the data scripts (restore drill,
 * raw-SQL audit, backfills). PlanetScale Postgres has no local proxy (unlike the MySQL
