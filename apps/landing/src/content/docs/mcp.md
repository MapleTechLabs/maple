...
- **Agent sessions** (AI/LLM agent traces) — `list_agent_sessions`, `get_agent_session`, `list_agent_session_spans`; `inspect_span` decodes an AI span's gen_ai attributes, captured messages and tool calls
