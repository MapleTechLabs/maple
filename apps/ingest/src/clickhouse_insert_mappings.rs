...
pub const PROJECT_REVISION: &str = "46001bd069c07ec8d4e47fd7aa9a5ed09b550f78ee28b93682a3d8242dc67766";
...
pub const DATASOURCES: &[InsertMapping] = &[
    ...
    InsertMapping {
        ...
        columns: &["OrgId", "SessionId", "Timestamp", "Seq", "Type", "Url", "TraceId", "Level", "Message", "TargetSelector", "TargetText", "NetMethod", "NetUrl", "NetStatus", "NetDurationMs", "ErrorStack", "Attributes", "VisitorId", "UserId", "GroupId"],
        selects: &["__ORG__", "session_id", "timestamp", "seq", "type", "url", "trace_id", "level", "message", "target_selector", "target_text", "net_method", "net_url", "net_status", "net_duration_ms", "error_stack", "attributes", "visitor_id", "user_id", "group_id"],
        input_schema: "session_id String, timestamp DateTime64(9), seq UInt32, type LowCardinality(String), url String, trace_id String, level LowCardinality(String), message String, target_selector String, target_text String, net_method LowCardinality(String), net_url String, net_status UInt16, net_duration_ms UInt32, error_stack String, attributes Map(String, String), visitor_id String, user_id String, group_id String",
    },
    InsertMapping {
        datasource: "product_events",
        table: "product_events",
        columns: &["OrgId", "Timestamp", "Source", "SessionId", "Seq", "VisitorId", "UserId", "GroupId", "Kind", "EventName", "Host", "PagePath", "Url", "ServiceName", "Attributes"],
        selects: &["__ORG__", "timestamp", "source", "session_id", "seq", "visitor_id", "user_id", "group_id", "kind", "event_name", "host", "page_path", "url", "service_name", "attributes"],
        input_schema: "timestamp DateTime64(9), source LowCardinality(String), session_id String, seq UInt32, visitor_id String, user_id String, group_id String, kind LowCardinality(String), event_name String, host LowCardinality(String), page_path String, url String, service_name LowCardinality(String), attributes Map(String, String)",
    },
];
...
pub fn mapping_for(datasource: &str) -> Option<&'static InsertMapping> {
    match datasource {
        ...
        "product_events" => Some(&DATASOURCES[9]),
        _ => None,
    }
}
