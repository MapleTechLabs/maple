...
import { v22ToV23AiTraceIndexClaudeCodeCostModule } from "./local-store-migrations/v22-to-v23-ai-trace-index-claude-code-cost"
import type {
...
export const localStoreMigrations: ReadonlyArray<AnyLocalStoreMigrationModule> = [
	...
	v22ToV23AiTraceIndexClaudeCodeCostModule,
]
