...
import { collectWarehouseQueryCatalog } from "./catalog"
...
} from "@maple/backend/services/warehouse/clickhouse-e2e-support"
...
const artifacts = fileURLToPath(new URL(`../.bench/${database}/`, import.meta.url))
const benchScript = fileURLToPath(new URL("../bench-queries.ts", import.meta.url))
