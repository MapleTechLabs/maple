...
const makeLayer = (
	...
	const workflowLive = Layer.effect(ErrorIssueWorkflowService, ErrorIssueWorkflowService.make).pipe(
	...
	const verificationLive = Layer.effect(IssueFixVerificationService, IssueFixVerificationService.make).pipe(
