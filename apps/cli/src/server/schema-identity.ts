...
export const LOCAL_SCHEMA_V23_SQL = snapshotAt(23).sql
export const LOCAL_SCHEMA_V23_MANIFEST = snapshotAt(23).manifest
...
export const LOCAL_SCHEMA_V23 = identityAt(23)
