...
export const aboutPage: CompanyPage = {
	title: "About Maple",
	description:
		"Maple is an open-source observability platform for traces, logs, and metrics, built on OpenTelemetry and operated by Makisuo, Inc.",
	sections: [
		{
			heading: "What Maple is",
			paragraphs: [
				"Maple is an observability platform for distributed systems. It ingests traces, logs, and metrics over the OpenTelemetry protocol (OTLP) and gives engineers a single place to search, correlate, and alert on them: distributed tracing with a service map, log search, metrics dashboards, error tracking with issue grouping, session replay for browser and mobile apps, Kubernetes monitoring, and alerting to Slack, Discord, Telegram, PagerDuty, email, or any webhook.",
				"There are no proprietary agents. Any application already instrumented with an OpenTelemetry SDK, collector, or auto-instrumentation can point its OTLP exporter at Maple and start sending data; switching observability vendors means changing an endpoint and a key.",
			],
		},
		{
...
export const contactPage: CompanyPage = {
	title: "Contact Maple",
	description:
		"How to reach the Maple team: support and general inquiries by email, community on Discord and GitHub, and the dedicated addresses for privacy and legal matters.",
	sections: [
		{
			heading: "Support and general inquiries",
			paragraphs: [
				`Email [${SUPPORT_EMAIL}](mailto:${SUPPORT_EMAIL}) for product support, billing, sales, press, and partnership questions. Include your organization name and, for a technical issue, a trace or session link so we can look at the same data you are looking at.`,
			],
		},
		{
			heading: "Community",
