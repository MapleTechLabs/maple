...
vi.mock("@/components/time-range-picker/page-refresh-context", async (importOriginal) => ({
	...(await importOriginal<typeof import("@/components/time-range-picker/page-refresh-context")>()),
...
vi.mock("@/hooks/use-effective-time-range", async (importOriginal) => ({
	...(await importOriginal<typeof import("@/hooks/use-effective-time-range")>()),
