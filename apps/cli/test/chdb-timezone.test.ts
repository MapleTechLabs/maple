...
/**
 * The embedded chDB engine resolves its SERVER timezone from the process environment at init,
 ...
 * native addon. This test asserts the value the chDB runtime would actually read.
 */
