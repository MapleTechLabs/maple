...
// Observe and cancel the real browser navigation so the test iframe stays alive.
...
describe("SelfHostedSignInPage", () => {
	beforeEach(() => {
		...
		window.navigation.addEventListener("navigate", preventNavigation)
	})

	afterEach(() => {
		cleanup()
		window.navigation.removeEventListener("navigate", preventNavigation)
	})
